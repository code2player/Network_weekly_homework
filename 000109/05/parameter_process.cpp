...
void para_need::set_name_type(int num, string para_name="", string para_type="int")
{
    para[num].para_name=para_name;
    para[num].para_type=para_type;
}

void para_need::set_default(int num, int para_whe_have_default=1, int para_value_default=0, string para_string_default="")
{
...
void para_need::set_value(int num, int para_whe_have_value=1, int para_value=0, string para_string="")
{
    para[num].para_whe_have_value=para_whe_have_value;
    para[num].para_value=para_value;
    para[num].para_string=para_string;
}
void para_need::set_range(int num, int para_whe_have_range=0, int min_range=0, int max_range=0)
{
